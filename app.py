...
st.markdown(
    ...
    /* Force input text to be black in light theme */
    .stApp[data-theme="light"] div[data-testid="stChatInput"] textarea,
    .stApp[data-theme="light"] div[data-testid="stChatInput"] input,
    .stApp[data-theme="light"] div[data-testid="stChatInput"] * {{
        color: black !important;
    }}
    
    /* Additional input text styling */
    .stApp[data-theme="light"] .stTextInput textarea,
    .stApp[data-theme="light"] .stTextInput input {{
        color: black !important;
    }}
    ...
    .stApp[data-theme="light"] .stTextInput textarea::placeholder,
    .stApp[data-theme="light"] .stTextInput input::placeholder {{
        color: black !important;
        opacity: 0.7 !important;
    }}
    
    /* Force placeholder color for all input elements */
    ...
    /* Chat input placeholder for both themes */
    div[data-testid="stChatInput"] textarea::placeholder {{
        color: black !important;
        opacity: 0.7 !important;
    }}
    
    /* Text input placeholders for both themes */
    ...
    /* Sidebar text input styling - "Enter your name" and other inputs */
    .stTextInput > div > div > input {{
        color: black !important;
    }}
    
    /* Sidebar text input placeholders */
    .stTextInput > div > div > input::placeholder {{
        color: black !important;
        opacity: 0.7 !important;
    }}
    
    /* Force black text for all sidebar inputs */
